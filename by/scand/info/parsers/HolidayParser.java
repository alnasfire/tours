...
import by.scand.info.problem.Request;
...
//                                System.out.println("country = " + ns.getChildren().elementAt(1).getLastChild().getLastChild().getText());//country
                                country = ns.getChildren().elementAt(1).getLastChild().getLastChild().getText();
                            }
...
//                                System.out.println("resort =" + ns.getChildren().elementAt(1).getLastChild().getText());//resort
                                resort = ns.getChildren().elementAt(1).getLastChild().getText();
                            }
...
//                                System.out.println(ns.getChildren().elementAt(0).getLastChild().getText()); //curency
                                price = ns.getChildren().elementAt(0).getChildren().elementAt(1).getText() + ns.getChildren().elementAt(0).getLastChild().getText();
                        }
                    }
...
//                                System.out.println("days = " + ns.getChildren().elementAt(0).getText().trim().substring(0, 15).trim());   //days
                                duration = ns.getChildren().elementAt(0).getText().trim().substring(0, 15).trim();
                        }
                    }
...
//                                System.out.println("firm name = " + ns.getChildren().elementAt(1).getLastChild().getLastChild().getText()); // firm name
                                firm_name = ns.getChildren().elementAt(1).getLastChild().getLastChild().getText();
                            }
...
//                        System.out.println("==========================");
                        try {
                            new Request(country, resort, departure, price, duration, firm_name, new String(phones), hotel);
                        } catch (IOException e) {
